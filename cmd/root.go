...
import (
	...
	"github.com/gkwa/myvolkswagen/internal/logger"
)
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.myvolkswagen.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		viper.SetConfigName(".myvolkswagen")
	}
